...
class core
{
	...
	private static $_app;//discuz_application对象
	...
	public static function creatapp() {
		if(!is_object(self::$_app)) {
			self::$_app = discuz_application::instance();//自动加载类./source/class/discdz/discdz_application.php
		}
		return self::$_app;//discuz_application对象
	}
