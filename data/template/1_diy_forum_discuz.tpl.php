...
<?php } ?>
<!--[diy=diy_chart]--><div id="diy_chart" class="area"><div id="tab84UkJW" class="frame-tab move-span cl"><div id="tab84UkJW_title" class="tab-title title column cl" switchtype="click"><span class="titletext"><a href="api.php?mod=vb" target="_blank" style="color:rgb(0, 0, 0) !important;">显示板块信息</a></span></div><div id="tab84UkJW_content" class="tb-c"></div><script type="text/javascript">initTab("tab84UkJW","click");</script></div></div><!--[/diy]-->
<div class="mn">
