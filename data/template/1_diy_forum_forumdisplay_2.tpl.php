...
0
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/forum/forumdisplay_leftside.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/forum/recommend.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/common/seccheck.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/forum/forumdisplay_list.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/forum/forumdisplay_sort.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/forum/search_sortoption.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/default//forum/forumdisplay_2.htm', './template/default/forum/search_sortoption.htm', 1477470674, 'diy', './data/template/1_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/default/', 'forum/forumdisplay_2')
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="tabBJrmf4" class="frame-tab move-span cl"><div id="tabBJrmf4_title" class="tab-title title column cl" switchtype="click"><span class="titletext"><a href="api.php?mod=vb" target="_blank" style="color:rgb(0, 0, 0) !important;">获取所有板块信息</a></span></div><div id="tabBJrmf4_content" class="tb-c"></div><script type="text/javascript">initTab("tabBJrmf4","click");</script></div></div><!--[/diy]-->
</div>
<div class="boardnav">
